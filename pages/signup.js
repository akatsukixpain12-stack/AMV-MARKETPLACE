...
export default function Signup() {
  ...
  const handleGoogleSignup = () => {
    toast.error('Google OAuth needs to be configured. Please use email signup for now.');
  };
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-card border border-white/10 rounded-2xl p-8">
          ...
          <button
            ...
            type="button"
            className="w-full flex items-center justify-center gap-3 px-4 py-3 rounded-lg border border-white/20 hover:bg-white/5 transition"
          >
